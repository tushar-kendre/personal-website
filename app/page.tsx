        ...
        <div className="relative z-10 h-full flex items-center py-24">
          <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-12">
            <div className="flex-1 max-w-2xl">
              <p className="text-slate-600 text-2xl md:text-3xl mb-4 font-light">Hello, I&apos;m</p>
              <h1 className="hero-text-static text-5xl md:text-7xl font-bold mb-4 leading-tight tracking-tight">
                {profile.name}
              </h1>
              <p className="hero-text-static text-xl md:text-2xl font-medium mb-4">{profile.title}</p>
              <div className="w-32 h-1 bg-gradient-to-r from-accent-blue to-accent-blue-light rounded-full mb-8" />

              <p className="text-slate-200 text-xl leading-relaxed mb-4">{intro.headline}</p>
              <p className="text-slate-300 leading-relaxed mb-3">{intro.summary}</p>
              <p className="text-slate-400 leading-relaxed mb-8">{intro.now}</p>
